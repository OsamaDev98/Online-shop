...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      showToast(
        "تم إرسال رسالتك بنجاح! سيتواصل معك أحد ممثلي الدعم الفني قريباً.",
        "success",
      );
      ...
      <section className="relative page-hero py-24 text-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <p className="text-base text-blue-100/70 font-medium max-w-xl mx-auto leading-relaxed">
            سواء كنت مقاولاً، مهندس تشطيبات، أو مالك منزل — فريقنا جاهز للرد على
            كافة استفساراتك وحصر المقاسات مجاناً.
          </p>
        </div>
        <div className="absolute bottom-0 left-0 right-0">
          ...
          >
            <path
              d="M0 50L1440 50L1440 15C1080 50 720 0 360 35L0 15L0 50Z"
              fill="#fafbff"
            />
          </svg>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-5">
            <div>
              ...
              <h2 className="text-2xl font-black text-[#0f1a3e]">
                تواصل بالطريقة المناسبة لك
              </h2>
              <p className="text-sm text-slate-500 mt-2 leading-relaxed">
                نوفر قنوات تواصل متعددة لضمان الرد السريع والدقيق.
              </p>
            </div>
            ...
            {[
              {
                ...
                sub: "نستقبل مكالماتكم خلال ساعات العمل",
                href: "tel:+201001234567",
              },
              {
                icon: FiMail,
                label: "بريد إلكتروني",
                value: "support@aluminum-expert.com",
                sub: "نلتزم بالرد خلال يوم عمل واحد",
                href: "mailto:support@aluminum-expert.com",
              },
              {
                icon: FiMapPin,
                label: "المعرض والمقر الرئيسي",
                value: "المنطقة الصناعية، القاهرة",
                sub: "يسعدنا استقبالكم لمعاينة المنتجات",
              },
              ...
              <div key={label}>
                {href ? (
                  <a
                    href={href}
                    className="group flex gap-4 p-5 rounded-2xl bg-white border border-slate-200 hover:border-primary-200 hover:shadow-md transition-all"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm font-extrabold text-[#0f1a3e] mt-0.5">
                        {value}
                      </p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[10px] text-emerald-600 mt-0.5">
                  الخيار المفضل لإرسال قوائم المقاسات والتسعير الفوري
                </p>
              </div>
            </a>
              ...
              <div className="space-y-2 text-sm">
                {[
                  ...
                  >
                    ...
                    <span className="text-[#0f1a3e] font-extrabold">
                      {hours}
                    </span>
                  </div>
                ))}
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-3xl border border-slate-200 shadow-lg p-8 space-y-5">
              <div className="flex items-center gap-2 pb-4 border-b border-slate-100">
                ...
                <h3 className="text-base font-extrabold text-[#0f1a3e]">
                  إرسال رسالة مباشرة
                </h3>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="shadcn-input text-left mt-2"
                    dir="ltr"
                  />
                </div>
      ...
      <section className="pb-20 bg-slate-50">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="border-b border-slate-200 pb-4 mb-6">
            <h2 className="text-xl font-extrabold text-[#0f1a3e]">
              موقع معرضنا ومقرنا الفني
            </h2>
            <p className="text-sm text-slate-500 mt-1">
              تفضل بزيارتنا لتفقد الإكسسوارات وتجربتها يدوياً
            </p>
          </div>
          <div className="relative h-72 sm:h-80 rounded-3xl overflow-hidden border border-slate-200 shadow-sm flex items-center justify-center bg-slate-200">
            ...
            <div className="relative z-10 glass-panel rounded-2xl p-6 text-center space-y-3 shadow-xl mx-4">
              ...
              <h4 className="text-sm font-extrabold text-[#0f1a3e]">
                ألومنيوم إكسبرت الرئيسي
              </h4>
              <p className="text-[10px] text-slate-500 leading-relaxed">
                المنطقة الصناعية الأولى، التجمع الخامس، القاهرة الجديدة.
              </p>
              <a
